...
/**
 * @}
 */   // end of group  WM_I2S_EXPORTED_CONSTANTS

typedef void (*tls_i2s_callback)();

/** @defgroup I2S_Exported_Types_Group1 I2S register Structure definition
 * @{
 */
typedef struct
{
...
/** @defgroup I2S_Exported_Types_Group2 I2S options Structure definition
 * @{
 */
...
/** @defgroup I2S_Exported_Types_Group3 I2S buf Structure definition
 * @{
 */
...
/** @defgroup I2S_Exported_Types_Group4 I2S port Structure definition
 * @{
 */
