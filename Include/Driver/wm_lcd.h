...
/** @defgroup LCD_Exported_Types_Group2 LCD bais enumeration Structure definition
 * @{
 */
typedef enum
{
...
/** @defgroup LCD_Exported_Types_Group3 LCD power enumeration Structure definition
 * @{
 */
typedef enum
{
...
/** @defgroup LCD_Exported_Types_Group4 LCD power select enumeration Structure definition
 * @{
 */
typedef enum
{
...
/** @defgroup LCD_Exported_Types_Group5 LCD mode select enumeration Structure definition
 * @{
 */
typedef enum
{
...
/** @defgroup LCD_Exported_Types_Group6 LCD duty select enumeration Structure definition
 * @{
 */
typedef enum
{
...
/** @defgroup I2S_Exported_Types_Group7 I2S options Structure definition
 * @{
 */
...
/**
 * @}
 */   // end of group  WM_LCD_Structs


/** @addtogroup WM_LCD_EXPORTED_FUNCTIONS LCD Exported Functions
  @{
*/
