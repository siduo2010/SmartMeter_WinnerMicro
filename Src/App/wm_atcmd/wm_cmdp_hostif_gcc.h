...
/* 	u8		verb;
 ...
 typedef struct _HOSTIF_CMD_PARAMS_TXCAL{
    u32 txlo;
    u32 txiqgain;
    u32 txiqphase;
 }	__attribute__((packed))HOSTIF_CMD_PARAMS_TXCAL;
...
#endif
 typedef struct _HOSTIF_CMDRSP_PARAMS_TXCAL{
    u32 txlo;
    u32 txiqgain;
    u32 txiqphase;
 }	__attribute__((packed))HOSTIF_CMDRSP_PARAMS_TXCAL;
...
#endif
	HOSTIF_CMDRSP_PARAMS_TXCAL  txcal;
    } ; 
